...
/// - ModelContext de SwiftData (thread-safe según Apple, pero no marcado Sendable)
///
/// # ============================================================
/// # EXCEPCIÓN DE CONCURRENCIA DOCUMENTADA
/// # ============================================================
/// Tipo: SDK de Apple no marcado Sendable
/// Componente: SwiftData.ModelContext
/// Justificación: Apple documenta que ModelContext es thread-safe cuando se usa
///                desde una única instancia (no compartido). Este repository
///                es singleton y ModelContext es inmutable (let).
/// Referencia: https://developer.apple.com/documentation/swiftdata/modelcontext
/// Ticket: N/A (limitación del SDK de Apple)
/// Fecha: 2025-11-28
/// Revisión: Revisar cuando Apple actualice SDK para marcar ModelContext como Sendable
/// # ============================================================
final class FeatureFlagRepositoryImpl: FeatureFlagRepository, @unchecked Sendable {
