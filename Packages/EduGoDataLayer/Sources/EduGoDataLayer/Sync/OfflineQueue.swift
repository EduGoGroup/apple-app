...
public actor OfflineQueue {
    ...
    public var executeRequest: (@Sendable (QueuedRequest) async throws -> Void)?
    ...
    public func configure(executor: @escaping @Sendable (QueuedRequest) async throws -> Void) {
    ...
    public func enqueue(_ request: QueuedRequest) async {
    ...
    public func allRequests() async -> [QueuedRequest] {
        queue
    }
