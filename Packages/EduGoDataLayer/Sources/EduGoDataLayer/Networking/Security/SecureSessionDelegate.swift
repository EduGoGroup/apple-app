...
/// # ============================================================
public final class SecureSessionDelegate: NSObject, URLSessionDelegate, @unchecked Sendable {
    // MARK: - Dependencies
...
public final class MockSecureSessionDelegate: NSObject, URLSessionDelegate, Sendable {
    /// Actor interno para estado mutable thread-safe
    public actor State {
        public var shouldAcceptChallenge = true
        public var challengeReceivedCount = 0
        public var lastHost: String?

        public init() {}

        public func recordChallenge(host: String) {
    ...
    public func getChallengeCount() async -> Int {
