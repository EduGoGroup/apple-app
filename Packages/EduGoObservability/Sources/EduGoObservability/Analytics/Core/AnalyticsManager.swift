...
//  EduGoObservability
//
//  Migrado desde apple-app/Data/Services/Analytics/
...
public actor AnalyticsManager: AnalyticsService {
    ...
    public func configure(with providers: [AnalyticsProvider]) async {
    ...
    public func track(_ event: AnalyticsEvent, parameters: [String: String]?) async {
    ...
    public func setUserProperty(_ property: AnalyticsUserProperty, value: String?) async {
