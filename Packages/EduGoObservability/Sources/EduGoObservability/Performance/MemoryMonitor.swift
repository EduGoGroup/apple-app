...
public actor MemoryMonitor {
    ...
    public func startMonitoring(interval: TimeInterval = 30) async {
    ...
    public nonisolated func currentMemoryUsage() -> MemoryUsage {
...
public struct MemoryUsage: Sendable {
    ...
    public nonisolated var residentMB: Double {
    ...
    /// ## Concurrency
    /// - nonisolated: Computed property sin estado
    public nonisolated var virtualMB: Double {
        Double(virtualBytes) / 1_048_576.0
    }

    public init(residentBytes: UInt64, virtualBytes: UInt64) {
