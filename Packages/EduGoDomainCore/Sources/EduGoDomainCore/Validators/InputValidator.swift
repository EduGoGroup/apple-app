...
public protocol InputValidator: Sendable {
...
public final class DefaultInputValidator: InputValidator {
    public init() {}
    ...
    public func isSafeSQLInput(_ input: String) -> Bool {
        let sqlPatterns = [
    ...
    public func isSafeHTMLInput(_ input: String) -> Bool {
        let xssPatterns = [
            "<script",
            "javascript:",
            "onerror=",
    ...
    public func isSafePath(_ path: String) -> Bool {
