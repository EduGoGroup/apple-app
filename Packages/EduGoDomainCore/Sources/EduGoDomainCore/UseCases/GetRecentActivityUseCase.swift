...
@MainActor
public protocol GetRecentActivityUseCase: Sendable {
...
@MainActor
public final class DefaultGetRecentActivityUseCase: GetRecentActivityUseCase {
    private let activityRepository: ActivityRepository

    public nonisolated init(activityRepository: ActivityRepository) {
        self.activityRepository = activityRepository
    }

    public func execute(limit: Int = 5) async -> Result<[Activity], AppError> {
