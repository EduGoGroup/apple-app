...
@MainActor
public final class DefaultSecurityValidator: SecurityValidator {
...
@MainActor
public final class MockSecurityValidator: SecurityValidator {
    public var isJailbrokenValue = false
    public var isDebuggerAttachedValue = false
