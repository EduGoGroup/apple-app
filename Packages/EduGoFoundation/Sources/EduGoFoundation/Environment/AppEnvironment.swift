...
//  Migrated on 30-11-25 - Sprint 3: Movido a EduGoFoundation para módulos SPM
...
public enum AppEnvironment {
    ...
    public enum EnvironmentType: String, Sendable, CaseIterable {
    ...
    public static var adminAPIBaseURL: URL {
        #if DEBUG
        return makeURL("http://localhost:8081")
        #elseif STAGING
        return makeURL("https://staging-api-admin.edugo.com")
    ...
    public static var authMode: AuthenticationMode {
        #if DEBUG
